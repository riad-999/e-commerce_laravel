...
<div {{$attributes->merge(['class' => 'swiper !overflow-y-visible'])}}> 
    <div class="swiper-wrapper" id="cat-{{$cat}}-container">
        @foreach($groups as $group)
            <div class="grid gap-4 swiper-slide px-4 desk:px-[50px]" style="grid-template-columns: repeat({{$len}},1fr);">
    ...
    @if(count($groups) > 1)
        <div class="swiper-pagination text-secondary absolute top-[20px] tablet:top-[90%] left-[50%] translate-x-[-50%] z-[5]"></div>
